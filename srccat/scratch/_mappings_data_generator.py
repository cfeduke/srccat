...
if __name__ == '__main__':
    ...
    for key, value in LEXERS.items():
        exts = map(clean_extension, extract_extensions(value))
    ...
    dict_file = open("extension_language_index.py", "w")
    dict_file.truncate()
    header = """
\"\"\"
...
"""
    ...
    print "Wrote %d entries to extension_language_index.py" % len(reverse_index)
